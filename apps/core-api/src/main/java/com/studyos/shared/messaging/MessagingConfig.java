    ...
    Declarables topology() {
        ...
        for (String exchange :
                List.of(
                        ...
                        "studyos.dlx")) elements.add(new TopicExchange(exchange, true, false));
        Queue q =
                QueueBuilder.durable("q.core.source-state.v1")
        ...
        elements.add(
                new Binding(
                        ...
                        "source.#",
                        null));
        Queue dlq = QueueBuilder.durable("q.core.dead.v1").build();
        elements.add(dlq);
        elements.add(
                new Binding(
                        dlq.getName(), Binding.DestinationType.QUEUE, "studyos.dlx", "#", null));
