...
public class PostgresLanguageStore implements LanguageStore {
    ...
    public PostgresLanguageStore(JdbcTemplate jdbc) {
        this.jdbc = jdbc;
    }

    public boolean validSegment(UUID source, UUID segment, String text) {
    ...
    public List<Map<String, Object>> vocabulary(UUID user, UUID notebook) {
        return jdbc.query(
                """
