...
public interface SourceRepository {
    ...
    UUID create(UUID user,UUID workspace,UUID notebook,String type,String title,String uri,String mime,long size,String checksum,String key,String status,UUID sourceId,UUID versionId,String objectKey);
    void queued(UUID sourceId,String checksum,long size);
