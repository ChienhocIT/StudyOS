...
public interface ConversationRepository {
    ...
    List<Map<String, Object>> messagePage(UUID conversation, Long after, Long before, int limit);

    List<Map<String, Object>> recentHistory(UUID conversation, int limit);
    ...
    Optional<Map<String, Object>> citationChunk(
