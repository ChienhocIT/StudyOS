...
public interface LearningStore {
    ...
    Map<String, Object> appendEvidence(UUID userId, UUID conceptId, String type, BigDecimal score,
            BigDecimal weight, String key, UUID activityId);
    ...
    void acceptConcept(UUID workspaceId, UUID notebookId, UUID sourceId, String name,
    ...
    Map<String, Object> createGoal(UUID userId, UUID workspaceId, String title, String description,
